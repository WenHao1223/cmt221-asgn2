...
CREATE TABLE WAREHOUSE (
    ...
    WHS_PHONE VARCHAR2(13) NOT NULL,
...
CREATE TABLE EMPLOYEE (
    ...
    EMP_TIN VARCHAR2(13) UNIQUE NOT NULL,
...
CREATE TABLE DRIVER (
    ...
    DRIVER_LICENSE_NO CHAR(15) UNIQUE NOT NULL,
...
CREATE TABLE ORDERS (
    ...
    ORD_RECIPENT_TITLE VARCHAR2(10) NOT NULL,
    ...
    CONSTRAINT ORD_DELIVERY_DATE_CHK CHECK (
        ORD_DELIVERY_DATE > ORD_DEALING_DATE
    ),
    ...
    CONSTRAINT ORD_RECIPENT_TITLE_CHK CHECK (
        ORD_RECIPENT_TITLE IN ('Mr', 'Ms', 'Mrs', 'Dr', 'Prof')
    ),
...
CREATE TABLE RECYCLE_ORDER (
    ...
    RORD_STATE CHAR(3) DEFAULT 'PND' NOT NULL,
    COM_ID VARCHAR2(10) NOT NULL,
...
CREATE TABLE RECYCLE_TRANSACTION (
    ...
    RTRANS_PAY_METHOD VARCHAR2(7) NOT NULL,
...
CREATE TABLE RETURNED_HISTORY (
    ...
    RHIS_DATE DATE DEFAULT SYSDATE NOT NULL,
    RHIS_STAT VARCHAR2(3),
    EMP_ID VARCHAR2(10) NOT NULL,
    RITEM_ID VARCHAR2(10) NOT NULL,
