...
CREATE TABLE ORDERS (
    ...
    ORD_DEALING_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE SECTION (
    ...
    SECT_DATE_CHECK DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE RETURNED_HISTORY (
    ...
    RET_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE RECYCLE_TRANSACTION (
    ...
    RTRANS_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE RECYCLE_ORDER (
    ...
    RORD_DEALING_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE RECYCLED_ITEM (
    ...
    RITEM_QC_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE PAYMENT (
    ...
    PAY_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE INVOICE (
    ...
    INV_DATE DATE NOT NULL DEFAULT SYSDATE,
...
CREATE TABLE FEEDBACKS (
    ...
    FDB_DATE DATE NOT NULL DEFAULT SYSDATE,
    ORD_ID CHAR(9) NOT NULL,
    -- FOREIGN KEY (ORD_ID) REFERENCES ORDERS(ORD_ID)
